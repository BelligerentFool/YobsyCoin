...
namespace Checkpoints
{
    ...
    // YOBSY: synchronized checkpoint (centrally broadcasted)
    ...
    // YOBSY: get last synchronized checkpoint
    ...
    // YOBSY: only descendant of current sync-checkpoint is allowed
    ...
    // YOBSY: reset synchronized checkpoint to last hardened checkpoint
...
// YOBSY: sync-checkpoint master key
const std::string CSyncCheckpoint::strMasterPubKey = "";

std::string CSyncCheckpoint::strMasterPrivKey = "";

// YOBSY: verify signature of sync-checkpoint message
...
// YOBSY: process synchronized checkpoint
