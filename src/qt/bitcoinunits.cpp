...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YOBSY");
    case mBTC: return QString("mYOBSY");
    case uBTC: return QString::fromUtf8("μYOBSY");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("YOBSY");
    case mBTC: return QString("Milli-YOBSY (1 / 1,000)");
    case uBTC: return QString("Micro-YOBSY (1 / 1,000,000)");
    default: return QString("???");
    }
}
