 ...
 * The YOBSY Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("YobsyCoin Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a YOBSY address"));
    ...
    aboutAction->setToolTip(tr("Show information about YOBSY"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for YOBSY"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &YOBSY"), this);
    toggleHideAction->setToolTip(tr("Show or hide the YOBSY window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/YOBSY_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/YOBSY_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("YOBSY client"));
    ...
    notificator = new Notificator(tr("YOBSY-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YOBSY network", "", count));
}
