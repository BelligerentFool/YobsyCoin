...
static const uint256 hashGenesisBlockOfficial("0x00000000088096bc31864867d8190fcb1468b1ba947c2690e2796a43acfb2996");
static const uint256 hashGenesisBlockTestNet("0x00000001f757bb737f6596503e17cd17b0658ce630cc727c0cca81aec47c9f06");

static const int64 nMaxClockDrift = 64 * 60;
...
public:
    ...
    {
        // YOBSY: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    int64 GetMinFee(unsigned int nBlockSize=1, bool fAllowFree=false, enum GetMinFee_mode mode=GMF_BLOCK) const
    {
        ...
        if (fAllowFree)
        {
            if (nBlockSize == 1)
            {
                // Transactions under YOBSY are free
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // YOBSY: get transaction coin age
...
public:
    ...
    // YOBSY: block signature - signed by coin base txout[0]'s owner
    ...
    // YOBSY: two types of block: proof-of-work or proof-of-stake
    ...
    // YOBSY: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // YOBSY: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // YOBSY: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // YOBSY: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // YOBSY: block index flags
    enum  
    {
