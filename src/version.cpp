...
const std::string CLIENT_NAME("YobsyCoin");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-YobbosChavsLads"
...
#ifndef BUILD_DESC
#    ifdef GIT_COMMIT_ID
#        define BUILD_DESC BUILD_DESC_FROM_COMMIT(PPCOIN_VERSION_MAJOR, PPCOIN_VERSION_MINOR, PPCOIN_VERSION_REVISION, PPCOIN_VERSION_BUILD)
#    else
